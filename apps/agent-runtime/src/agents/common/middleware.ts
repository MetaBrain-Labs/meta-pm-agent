...
const DEFAULT_CONTEXT_EDIT_TRIGGER_TOKENS = 24_000;
const DEFAULT_CONTEXT_EDIT_KEEP_TOOL_RESULTS = 4;
const DEFAULT_MODEL_CALL_RUN_LIMIT = 8;
const DEFAULT_TOOL_CALL_RUN_LIMIT = 18;
